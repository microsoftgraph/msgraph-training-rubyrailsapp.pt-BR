# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="99861-101">Como executar o projeto concluído</span><span class="sxs-lookup"><span data-stu-id="99861-101">How to run the completed project</span></span>
