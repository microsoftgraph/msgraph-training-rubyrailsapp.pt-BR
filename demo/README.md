# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="f2e2a-101">Como executar o projeto concluído</span><span class="sxs-lookup"><span data-stu-id="f2e2a-101">How to run the completed project</span></span>
